...
public class TerrenosFactory {
	...
	public Terreno crearTucuman() {
		...
		Terreno tucuman = new TerrenoSimple(25000,"Tucuman",7000,alquiler);
		return tucuman;
	...
	public Terreno crearNeuquen() {
		...
		Terreno neuquen = new TerrenoSimple(17000,"Neuquen",4800,alquiler);
		return neuquen;
	}
	
	public Terreno crearSantaFe() {
		AlquilerTerrenoSimple alquiler = new AlquilerTerrenoSimple(1500,3500);
		Terreno santaFe = new TerrenoSimple(15000,"Santa Fe",4000,alquiler);
		return santaFe;
	}
	
	public TerrenoDoble crearBuenosAiresNorte() {
		AlquilerTerrenoDoble alquiler = new AlquilerTerrenoDoble(2500,3500,4000,6000);
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(25000,5500,9000,"Buenos Aires Norte",alquiler);
	...
	public TerrenoDoble crearBuenosAiresSur() {
		...
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(20000,5000,8000,"Buenos Aires Sur",alquiler);
		return buenosAiresNorte;
	}
	
	public TerrenoDoble crearCordobaNorte() {
		AlquilerTerrenoDoble alquiler = new AlquilerTerrenoDoble(1300,1800,2900,3500);
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(20000,2200,3500,"Cordoba Norte", alquiler);
		return buenosAiresNorte;
	}
	
	public TerrenoDoble crearCordobaSur() {
		AlquilerTerrenoDoble alquiler = new AlquilerTerrenoDoble(1000,1500,2500,3000);
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(18000,2000,3000,"Cordoba Sur",alquiler);
		return buenosAiresNorte;
	}
	
	public TerrenoDoble crearSaltaNorte() {
		AlquilerTerrenoDoble alquiler = new AlquilerTerrenoDoble(2000,3250,3850,5500);
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(23000,4500,7500,"Salta Norte",alquiler);
		return buenosAiresNorte;
	}
	
	public TerrenoDoble crearSaltaSur() {
		AlquilerTerrenoDoble alquiler = new AlquilerTerrenoDoble(2000,3250,3850,5500);
		TerrenoDoble buenosAiresNorte = new TerrenoDoble(23000,4500,7500,"Salta Sur",alquiler);
		return buenosAiresNorte;
	}
